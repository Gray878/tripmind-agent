package com.hgh.tripmindagent.rag;
...
// TODO: 后续实现 TripMind 文档加载器后，取消注释并更新文档加载逻辑
//@Configuration
public class PgVectorVectorStoreConfig {

//    @Resource
//    private TripMindDocumentLoader tripMindDocumentLoader;
//
//    @Bean
...
//                .build();
//        // 加载文档
//        List<Document> documents = tripMindDocumentLoader.loadMarkdowns();
